...
public class Archer extends Kit {
	...
	public void setItemDefault(Player player) {
		...
		player.getInventory().setItem(0, Helper.createItem(Material.IRON_SWORD, "Epée du kit Archer"));
		player.getInventory().setItem(1, Helper.createItem(Material.APPLE, "Pain du kit Archer"));
		player.sendMessage(Management.prefix + "Vous avez reçu le kit Archer");
